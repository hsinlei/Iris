...
RatingsFilter.defaultQuery = function (value, props) {
	var includeNullValues = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
	...
	if (value) {
		...
		if (includeNullValues) {
			var nullQuery = RatingsFilter.getNullValuesQuery(props.dataField);
			query = {
				bool: {
...
RatingsFilter.getNullValuesQuery = function (fieldName) {
	return {
		bool: {
			must_not: {
				exists: {
...
var _initialiseProps = function _initialiseProps() {
	...
	this.updateQuery = function (value, props, includeNullValues) {
		var customQuery = props.customQuery;

		var query = RatingsFilter.defaultQuery(value, props, includeNullValues);
